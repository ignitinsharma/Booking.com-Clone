...
const Register = () => {
  ...
  return (
    <div style={{fontFamily:"roboto",color:"#333"}}>
        ...
        <div style={{width:"30%",margin:"auto",marginTop:"70px"}}>
            <h2 style={{fontSize:"25px",fontWeight:"bold"}}>Register or create an account</h2>
            <div style={{marginTop:"30px"}}>
                ...
                <label style={{fontWeight:"bold"}} htmlFor="">Password</label><br></br>
                <input value={password} onChange={(e)=>password(e.target.value)} style={{marginTop:"6px",height:"36px",padding:"4px 8px",width:"100%",border:"1px solid #ABAFB2"}} type="password" />
            </div>
